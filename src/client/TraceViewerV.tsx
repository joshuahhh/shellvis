...
import { Trace, pipeData } from "../shared/execution.js";
...
export const TraceViewerV = memo((props: TraceViewerVProps) => {
  ...
  let [historyIdx, setHistoryIdx] = React.useState<number | undefined>(
    undefined,
  );
  ...
  useEffect(() => {
    ...
    const onMessage = (e: MessageEvent<string>) => {
      ...
      if (vsEvent.textEditor.document.fileName !== trace.runParams.path) {
        return;
      }
        ...
        {Object.entries(trace.execInfos).map(([execId, execInfo]) => {
          ...
          return (
            <Fragment key={execId}>
              ...
              <dd>
                <div>
                  <b>stdout</b> {stdout.done && <small>✓</small>}
                </div>
                <pre>{pipeData(stdout)}</pre>
                <div>
                  <b>stderr</b> {stderr.done && <small>✓</small>}
                </div>
          ...
          return (
            <Fragment key={execId}>
              ...
              <dd>
                ...
                <ul>
                  {forInfo.iterations.map((iteration, i) => (
                    <li key={i}>
                      <div>
                        <b>counter</b> {iteration.counter}
                      </div>
                      <div>
                        <b>loopVarValue</b> {iteration.loopVarValue}
                      </div>
                    </li>
                  ))}
                </ul>
  ...
  return (
    <HVContext.Provider value={hvContext}>
      ...
      <div className="fixed top-3 right-3 flex flex-row gap-4 items-center">
      ...
      {!hvContext.minimal && (
        <div className="fixed bottom-2 right-14 text-5xl opacity-20 -z-50">
          ShellVis
        </div>
      )}
            ...
            >
              ...
              <Label className="flex items-center gap-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    hvContextUP.detailsMode.$set(value as any)
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
              ...
              <Label className="flex items-center gap-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    hvContextUP.abbreviateInfo.$set(value as any)
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="outside-selection">
                      outside-selection
                    </SelectItem>
              ...
              <label>
                <input
                  ...
                  onChange={(e) =>
                    hvContextUP.showTimeSlider.$set(e.target.checked)
                  }
              ...
              <label>
                <input
                  ...
                  onChange={(e) =>
                    hvContextUP.showMessages.$set(e.target.checked)
                  }
                  style={{ marginRight: 10 }}
                />
                Show messages
